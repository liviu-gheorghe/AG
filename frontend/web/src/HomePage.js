...
function HomePage(props) {
    ...
    useEffect(
        () => {
            setProblemData(require('./assets/strings/home_page.json'))
        }
    )
    return (
        <>
            <div className="background_wrapper">
                <Header language={props.language} bgVariant=" " logged_user={props.cookies.get('username')} />
                <Container fluid>
                    <Row style={{ height: "100vh" }} className="align-items-center">
                        <Col className="wallpaper_content justify-content-center align-items-center" xs={12} md={12} lg={12} xl={5} >
                            <h2>{props.homepage_data['wallpaper_description']['text'][props.language]}</h2>
            ...
            <Container>
                <Row className="justify-content-center homepage_info">
                    <Col xs={12}>
                        <p className="subtitle">{props.homepage_data['platform_description_subtitle']['text'][props.language]}</p>
                    </Col>
